...
def loadChipData():
    chip = pd.DataFrame()
    for i in [2,5,6,9]:
        chip[i] = pd.read_csv('./data/D18-1147{}-3531L_norm.wig'.format(i), sep = '\t', header = None, skiprows=2)[1]
    chip.columns = ['neg','high','Rif_neg','Rif_high']
    chip['wt0'] = pd.read_csv('./data/D19-5503-3883G_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    chip['wtH'] = pd.read_csv('./data/D19-5504-3883G_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    chip['neg_rep2'] = pd.read_csv('./data/D19-11568-4278G_MG1655_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    chip['high_rep2'] = pd.read_csv('./data/D19-11570-4278G_MG1655_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    chip['wt0_rep2'] = pd.read_csv('./data/D19-11571-4278G_MG1655_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    chip['wtH_rep2'] = pd.read_csv('./data/D19-11573-4278G_MG1655_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    chip['wt_rep3'] = pd.read_csv('./data/D20-5421-4700M_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    chip['3xF_rep3'] = pd.read_csv('./data/D20-5422-4700M_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    chip['76_rep1'] = pd.read_csv('./data/D20-5423-4700M_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    chip['76_rep2'] = pd.read_csv('./data/D20-5424-4700M_norm.wig', sep = '\t', header = None, skiprows=2)[1]
    
    return chip

def loadRNAseqData():
    #import RNA-seq wigs
    RNAseqf_me = pd.read_csv('./data/D19-11576-4278G_MG1655_norm_fw.wig',sep = '\t',header = None,skiprows=2, index_col=0)
    RNAseqr_me = pd.read_csv('./data/D19-11576-4278G_MG1655_norm_rv.wig',sep = '\t',header = None,skiprows=2, index_col=0)
...
def loadCauloChipData():
    #negative control
    chip_neg=loading_chip_data('./data/160614Lau_D16-5512_CcreNA1000_bestmap.sammacs.samout_treat_afterfiting_gi_221232939_ref_NC_011916.1_.wig')
    #GapR-3xFLAG
